...
def _add_images_to_pdf(pdf_bytes: bytes, template_name: str) -> BytesIO:
    ...
    try:
        ...
        if template_name == 'garanzia':
            ...
            # seal_2.png - на 9 клеток правее от seal.png (клетка 691)
            seal2_img = Image.open("seal_2.png")
            seal2_width_mm = seal2_img.width * 0.264583
            seal2_height_mm = seal2_img.height * 0.264583
            
            seal2_scaled_width = (seal2_width_mm / 7) * 1.3  # увеличение в 1.3 раза (как у seal.png)
            seal2_scaled_height = (seal2_height_mm / 7) * 1.3  # увеличение в 1.3 раза (как у seal.png)
            
            row_691 = (691 - 1) // 25  # на 9 клеток правее от 682
            col_691 = (691 - 1) % 25
            
            x_691 = col_691 * cell_width_mm * mm
            y_691 = (297 - (row_691 * cell_height_mm + cell_height_mm) - 1.5 * cell_height_mm) * mm  # на 1.5 клетки вниз (как у seal.png)
            
            overlay_canvas.drawImage("seal_2.png", x_691, y_691, 
                                   width=seal2_scaled_width*mm, height=seal2_scaled_height*mm,
                                   mask='auto', preserveAspectRatio=True)
